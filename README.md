...
- App includes a soothing loading overlay before game module lock-in so transitions feel intentional.
- Platform-style launcher and persistent profile are inspired by modular experience systems.
